...
export const DashboardPage = () => {
  ...
  const connectWallet = async () => {
    try {
      ...
      console.log("Connected wallet:", ethereumAddress);
  ...
  const doctorStats = [
    ...
    },
    {
      ...
      value:
        accessRequestsData?.accessRequests?.filter(
  ...
  const patientStats = [
    ...
    },
    {
      ...
      value:
        pendingRequestsData?.pendingRequests?.filter(
          (req) => req.status === "PENDING"
        )?.length || 0,
      icon: Clock,
      color: "bg-orange-500",
        ...
        {user.role === "DOCTOR" ? (
          <>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                {accessRequestsData?.accessRequests
